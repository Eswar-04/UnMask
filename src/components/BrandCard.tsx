...
import { Expand, ChevronDown, Image, Info } from 'lucide-react';
                  ...
                  {subBrands.map((subBrand, index) => (
                    ...
                    >
                      {subBrand.logo ? (
                        ...
                        <motion.div 
                          className="w-10 h-10 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full mr-3 flex items-center justify-center text-gray-500"
                          whileHover={{ scale: 1.2, rotate: 5 }}
                        >
